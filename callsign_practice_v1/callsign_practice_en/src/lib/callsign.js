...
export const PRACTICE_MODES = [
  {
    id: "mixed",
    label: "Transport + GA",
    summary: "Airline IATA + digits, or aircraft type + suffix.",
    instruction: "Listen for either an airline callsign or an aircraft type plus suffix."
  },
  {
    id: "transport",
    label: "Transport Airline",
    summary: "IATA code + 3 to 4 digit flight number.",
    instruction: "Answer full IATA callsign or just the digits suffix."
  },
  {
    id: "generalAviation",
    label: "General Aviation",
    summary: "Aircraft type + letter or mixed suffix.",
    instruction: "Answer only the digits suffix"
  },
  {
    id: "numeric",
    label: "Numeric Only",
    summary: "Standalone grouped numeric callsign.",
    instruction: "Answer the numeric callsign."
  },
  {
    id: "letters",
    label: "Custom Letters",
    summary: "Custom letter pool with configurable length.",
...
function buildTransportSample() {
  ...
  return finalizeSample({
    mode: "transport",
    label: "Transport Airline",
    instruction: "Answer full IATA callsign or just digits suffix.",
    ...
    revealAnswer: `${airline.code}${flightNumber} (type: ${flightNumber} or ${airline.code}${flightNumber})`,
