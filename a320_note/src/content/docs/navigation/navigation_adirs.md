...
The three ADR and the three IR switches normally remain on, but they can be selected off in response to ECAM procedures.

 ![alt text](image-15.png)

In the "NAV" position the ADIRU is energized. The "NAV"position is the normal mode of operation and full inertial data is provided to the aircraft systems.
...
- Another one for high lift configuration (refer to the end of the presentation).
